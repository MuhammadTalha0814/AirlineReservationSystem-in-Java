...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/airlinereservationsystem/Screenshot (30).png"))); // NOI18N
        ...
        LOGIN.setBackground(new java.awt.Color(218, 216, 216));
    ...
    private void LOGINMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_LOGINMouseClicked
        ...
        boolean flag=ta.Login(username, password);
        if(flag==true)
        {
            this.dispose();
        }
